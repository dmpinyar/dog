  ...
  return (
    <body style={{ background: "#d2b48c", color: "#000000" }}>
      ...
      >
        ...
        >
          {instant && active ? (
            <p>
              ...
              <br></br>
              Starting date: {instant.startMonth}/{instant.startDay}/
              {instant.startYear}
              <br></br>
              Terminating date: {instant.endMonth}/{instant.endDay}/
              {instant.endYear}
              <br></br>
              ...
              <br></br>
              It took about {prog[0].time} seconds to parse through today's
              data!
            </p>
          ) : (
        ...
        >
          <p>
            Here's the past twenty scraped days!
            <hr></hr>
            {
              <ol>
                {prog.map((data, index) => (
                  <li key={index}>
                    {data.month}/{data.day}/{data.year}: the process took{" "}
                    {data.time} seconds, and {data.horses} horses ran!
                  </li>
                ))}
              </ol>
            }
